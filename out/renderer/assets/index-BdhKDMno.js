 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const LogOut$1 = createLucideIcon("LogOut", [
...
const node_fetch_1 = __importDefault$4(require$$0);
const PostgrestError_1 = __importDefault$4(PostgrestError$1);
...
const PostgrestBuilder_1 = __importDefault$3(PostgrestBuilder$2);
...
(function(exports) {
  ...
  var PostgrestClient_1 = PostgrestClient$2;
  ...
  var PostgrestQueryBuilder_12 = PostgrestQueryBuilder$2;
  ...
  var PostgrestFilterBuilder_12 = PostgrestFilterBuilder$2;
  ...
  var PostgrestTransformBuilder_12 = PostgrestTransformBuilder$2;
  ...
  var PostgrestBuilder_12 = PostgrestBuilder$2;
...
const index = /* @__PURE__ */ getDefaultExportFromCjs(cjs);
const {
...
class RealtimeClient {
  ...
  connect() {
    ...
    __vitePreload(async () => {
      const { default: WS } = await import("./browser-DRYMufPF.js").then((n2) => n2.b);
      return { default: WS };
...
function setSession({ sessionStatus, userId }) {
...
function LogOut() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "icon", onClick: handleClearSession, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LogOut$1, {}) });
}
function MainPage() {
  const navigate = useNavigate();
  reactExports.useEffect(() => {
    ...
    const subscription = supabase.channel("command-channel").on(
      "postgres_changes",
      {
        event: "INSERT",
        schema: "public",
      ...
      async (payload) => {
        ...
        window.api.onCommandResult(async (result) => {
          await supabase.from("command_history").update({ status: "completed", output: result, updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", payload.new.id);
        });
      }
    ).subscribe();
    return () => {
  ...
  reactExports.useEffect(() => {
    const handleInfoDeviceLocal = (_event, result) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex w-screen h-screen justify-center items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { id: "titlebar", className: "fixed top-0 left-0 w-screen p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(LogOut, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: getInfoDeviceFunction, children: "Get Info Device" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Main Page" })
  ] });
}
...
var pt = (r2, s2, e) => s2 in r2 ? Wt(r2, s2, { enumerable: true, configurable: true, writable: true, value: e }) : r2[s2] = e, gt = (r2, s2) => {
  for (var e in s2 || (s2 = {})) Rt.call(s2, e) && pt(r2, e, s2[e]);
  if (U) for (var e of U(s2)) vt.call(s2, e) && pt(r2, e, s2[e]);
  return r2;
}, Et = (r2, s2) => Bt(r2, At(s2));
var St = (r2, s2) => {
  var e = {};
  for (var u2 in r2) Rt.call(r2, u2) && s2.indexOf(u2) < 0 && (e[u2] = r2[u2]);
  if (r2 != null && U) for (var u2 of U(r2)) s2.indexOf(u2) < 0 && vt.call(r2, u2) && (e[u2] = r2[u2]);
  return e;
};
var bt = "^\\d+$", Ft = "^[a-zA-Z0-9]+$";
function Pt(r2) {
...
var kt = 18, _t = 40, Ot = `${_t}px`, Gt = ["[data-lastpass-icon-root]", "com-1password-button", "[data-dashlanecreated]", '[style$="2147483647 !important;"]'].join(",");
function wt({ containerRef: r2, inputRef: s2, pushPasswordManagerStrategy: e, isFocused: u2 }) {
  let h = reactExports.useRef({ done: false, refocused: false }), [W2, B2] = reactExports.useState(false), [z2, q2] = reactExports.useState(false), [j, A2] = reactExports.useState(false), V2 = reactExports.useMemo(() => e === "none" ? false : (e === "increase-width" || e === "experimental-no-flickering") && W2 && z2, [W2, z2, e]), c = reactExports.useCallback(() => {
    let v2 = r2.current, m2 = s2.current;
    if (!v2 || !m2 || j || e === "none") return;
    let g = v2, k2 = g.getBoundingClientRect().left + g.offsetWidth, M2 = g.getBoundingClientRect().top + g.offsetHeight / 2, a = k2 - kt, b = M2;
    if (!(document.querySelectorAll(Gt).length === 0 && document.elementFromPoint(a, b) === v2) && (B2(true), A2(true), !h.current.refocused && document.activeElement === m2)) {
      let d = [m2.selectionStart, m2.selectionEnd];
      m2.blur(), m2.focus(), m2.setSelectionRange(d[0], d[1]), h.current.refocused = true;
    }
  }, [r2, s2, j, e]);
  return reactExports.useEffect(() => {
    let v2 = r2.current;
    if (!v2 || e === "none") return;
    function m2() {
      let M2 = window.innerWidth - v2.getBoundingClientRect().right;
      q2(M2 >= _t);
    }
    m2();
    let g = setInterval(m2, 1e3);
    return () => {
      clearInterval(g);
    };
  }, [r2, e]), reactExports.useEffect(() => {
    let v2 = u2 || document.activeElement === s2.current;
    if (e === "none" || !v2) return;
    let m2 = setTimeout(c, 0), g = setTimeout(c, 2e3), k2 = setTimeout(c, 5e3), M2 = setTimeout(() => {
      A2(true);
    }, 6e3);
    return () => {
      clearTimeout(m2), clearTimeout(g), clearTimeout(k2), clearTimeout(M2);
    };
  }, [s2, u2, e, c]), { hasPWMBadge: W2, willPushPWMBadge: V2, PWM_BADGE_SPACE_WIDTH: Ot };
}
var xt = reactExports.createContext({}), jt = reactExports.forwardRef((m2, v2) => {
  var g = m2, { value: r2, onChange: s2, maxLength: e, textAlign: u2 = "left", pattern: h = bt, inputMode: W2 = "numeric", onComplete: B2, pushPasswordManagerStrategy: z2 = "increase-width", containerClassName: q2, noScriptCSSFallback: j = Lt, render: A2, children: V2 } = g, c = St(g, ["value", "onChange", "maxLength", "textAlign", "pattern", "inputMode", "onComplete", "pushPasswordManagerStrategy", "containerClassName", "noScriptCSSFallback", "render", "children"]);
  var Y2, it, lt, ut, dt;
  let [k2, M2] = reactExports.useState(typeof c.defaultValue == "string" ? c.defaultValue : ""), a = r2 != null ? r2 : k2, b = ht(a), O2 = reactExports.useCallback((t2) => {
    s2 == null || s2(t2), M2(t2);
  }, [s2]), d = reactExports.useMemo(() => h ? typeof h == "string" ? new RegExp(h) : h : null, [h]), i2 = reactExports.useRef(null), K2 = reactExports.useRef(null), J2 = reactExports.useRef({ value: a, onChange: O2, isIOS: typeof window != "undefined" && ((it = (Y2 = window == null ? void 0 : window.CSS) == null ? void 0 : Y2.supports) == null ? void 0 : it.call(Y2, "-webkit-touch-callout", "none")) }), X2 = reactExports.useRef({ prev: [(lt = i2.current) == null ? void 0 : lt.selectionStart, (ut = i2.current) == null ? void 0 : ut.selectionEnd, (dt = i2.current) == null ? void 0 : dt.selectionDirection] });
  reactExports.useImperativeHandle(v2, () => i2.current, []), reactExports.useEffect(() => {
    let t2 = i2.current, o2 = K2.current;
    if (!t2 || !o2) return;
    J2.current.value !== t2.value && J2.current.onChange(t2.value), X2.current.prev = [t2.selectionStart, t2.selectionEnd, t2.selectionDirection];
    function f2() {
      if (document.activeElement !== t2) {
        N2(null), $(null);
        return;
      }
      let l2 = t2.selectionStart, S2 = t2.selectionEnd, w2 = t2.selectionDirection, y2 = t2.maxLength, D2 = t2.value, P2 = X2.current.prev, E2 = -1, T2 = -1, I2;
      if (D2.length !== 0 && l2 !== null && S2 !== null) {
        let yt = l2 === S2, Dt = l2 === D2.length && D2.length < y2;
        if (yt && !Dt) {
          let H2 = l2;
          if (H2 === 0) E2 = 0, T2 = 1, I2 = "forward";
          else if (H2 === y2) E2 = H2 - 1, T2 = H2, I2 = "backward";
          else if (y2 > 1 && D2.length > 1) {
            let et = 0;
            if (P2[0] !== null && P2[1] !== null) {
              I2 = H2 < P2[1] ? "backward" : "forward";
              let Ht = P2[0] === P2[1] && P2[0] < y2;
              I2 === "backward" && !Ht && (et = -1);
            }
            E2 = et + H2, T2 = et + H2 + 1;
          }
        }
        E2 !== -1 && T2 !== -1 && E2 !== T2 && i2.current.setSelectionRange(E2, T2, I2);
      }
      let ft = E2 !== -1 ? E2 : l2, mt = T2 !== -1 ? T2 : S2, Ct = I2 != null ? I2 : w2;
      N2(ft), $(mt), X2.current.prev = [ft, mt, Ct];
    }
    if (document.addEventListener("selectionchange", f2, { capture: true }), f2(), document.activeElement === t2 && Q2(true), !document.getElementById("input-otp-style")) {
      let l2 = document.createElement("style");
      if (l2.id = "input-otp-style", document.head.appendChild(l2), l2.sheet) {
        let S2 = "background: transparent !important; color: transparent !important; border-color: transparent !important; opacity: 0 !important; box-shadow: none !important; -webkit-box-shadow: none !important; -webkit-text-fill-color: transparent !important;";
        F(l2.sheet, "[data-input-otp]::selection { background: transparent !important; color: transparent !important; }"), F(l2.sheet, `[data-input-otp]:autofill { ${S2} }`), F(l2.sheet, `[data-input-otp]:-webkit-autofill { ${S2} }`), F(l2.sheet, "@supports (-webkit-touch-callout: none) { [data-input-otp] { letter-spacing: -.6em !important; font-weight: 100 !important; font-stretch: ultra-condensed; font-optical-sizing: none !important; left: -1px !important; right: 1px !important; } }"), F(l2.sheet, "[data-input-otp] + * { pointer-events: all !important; }");
      }
    }
    let p2 = () => {
    ...
    p2();
    let _ = new ResizeObserver(p2);
    return _.observe(t2), () => {
      document.removeEventListener("selectionchange", f2, { capture: true }), _.disconnect();
    };
  }, []);
  let [nt, ot] = reactExports.useState(false), [L2, Q2] = reactExports.useState(false), [C2, N2] = reactExports.useState(null), [G2, $] = reactExports.useState(null);
  reactExports.useEffect(() => {
    Pt(() => {
      var p2, _, l2, S2;
      (p2 = i2.current) == null || p2.dispatchEvent(new Event("input"));
      let t2 = (_ = i2.current) == null ? void 0 : _.selectionStart, o2 = (l2 = i2.current) == null ? void 0 : l2.selectionEnd, f2 = (S2 = i2.current) == null ? void 0 : S2.selectionDirection;
      t2 !== null && o2 !== null && (N2(t2), $(o2), X2.current.prev = [t2, o2, f2]);
    });
  }, [a, L2]), reactExports.useEffect(() => {
    b !== void 0 && a !== b && b.length < e && a.length === e && (B2 == null || B2(a));
  }, [e, B2, b, a]);
  let x2 = wt({ containerRef: K2, inputRef: i2, pushPasswordManagerStrategy: z2, isFocused: L2 }), rt = reactExports.useCallback((t2) => {
    let o2 = t2.currentTarget.value.slice(0, e);
    if (o2.length > 0 && d && !d.test(o2)) {
      t2.preventDefault();
      return;
    }
    typeof b == "string" && o2.length < b.length && document.dispatchEvent(new Event("selectionchange")), O2(o2);
  }, [e, O2, b, d]), st = reactExports.useCallback(() => {
    var t2;
    if (i2.current) {
      let o2 = Math.min(i2.current.value.length, e - 1), f2 = i2.current.value.length;
      (t2 = i2.current) == null || t2.setSelectionRange(o2, f2), N2(o2), $(f2);
    }
    Q2(true);
  }, [e]), ct = reactExports.useCallback((t2) => {
    var P2, E2;
    let o2 = i2.current;
    if (!J2.current.isIOS || !t2.clipboardData || !o2) return;
    let f2 = t2.clipboardData.getData("text/plain");
    t2.preventDefault();
    let p2 = (P2 = i2.current) == null ? void 0 : P2.selectionStart, _ = (E2 = i2.current) == null ? void 0 : E2.selectionEnd, w2 = (p2 !== _ ? a.slice(0, p2) + f2 + a.slice(_) : a.slice(0, p2) + f2 + a.slice(p2)).slice(0, e);
    if (w2.length > 0 && d && !d.test(w2)) return;
    o2.value = w2, O2(w2);
    let y2 = Math.min(w2.length, e - 1), D2 = w2.length;
    o2.setSelectionRange(y2, D2), N2(y2), $(D2);
  }, [e, O2, d, a]), Tt = reactExports.useMemo(() => ({ position: "relative", cursor: c.disabled ? "default" : "text", userSelect: "none", WebkitUserSelect: "none", pointerEvents: "none" }), [c.disabled]), at = reactExports.useMemo(() => ({ position: "absolute", inset: 0, width: x2.willPushPWMBadge ? `calc(100% + ${x2.PWM_BADGE_SPACE_WIDTH})` : "100%", clipPath: x2.willPushPWMBadge ? `inset(0 ${x2.PWM_BADGE_SPACE_WIDTH} 0 0)` : void 0, height: "100%", display: "flex", textAlign: u2, opacity: "1", color: "transparent", pointerEvents: "all", background: "transparent", caretColor: "transparent", border: "0 solid transparent", outline: "0 solid transparent", boxShadow: "none", lineHeight: "1", letterSpacing: "-.5em", fontSize: "var(--root-height)", fontFamily: "monospace", fontVariantNumeric: "tabular-nums" }), [x2.PWM_BADGE_SPACE_WIDTH, x2.willPushPWMBadge, u2]), It = reactExports.useMemo(() => reactExports.createElement("input", Et(gt({ autoComplete: c.autoComplete || "one-time-code" }, c), { "data-input-otp": true, "data-input-otp-mss": C2, "data-input-otp-mse": G2, inputMode: W2, pattern: d == null ? void 0 : d.source, style: at, maxLength: e, value: a, ref: i2, onPaste: (t2) => {
    var o2;
    ct(t2), (o2 = c.onPaste) == null || o2.call(c, t2);
  }, onChange: rt, onMouseOver: (t2) => {
    var o2;
    ot(true), (o2 = c.onMouseOver) == null || o2.call(c, t2);
  }, onMouseLeave: (t2) => {
    var o2;
    ot(false), (o2 = c.onMouseLeave) == null || o2.call(c, t2);
  }, onFocus: (t2) => {
    var o2;
    st(), (o2 = c.onFocus) == null || o2.call(c, t2);
  }, onBlur: (t2) => {
    var o2;
    Q2(false), (o2 = c.onBlur) == null || o2.call(c, t2);
  } })), [rt, st, ct, W2, at, e, G2, C2, c, d == null ? void 0 : d.source, a]), tt = reactExports.useMemo(() => ({ slots: Array.from({ length: e }).map((t2, o2) => {
    let f2 = L2 && C2 !== null && G2 !== null && (C2 === G2 && o2 === C2 || o2 >= C2 && o2 < G2), p2 = a[o2] !== void 0 ? a[o2] : null;
    return { char: p2, isActive: f2, hasFakeCaret: f2 && p2 === null };
  }), isFocused: L2, isHovering: !c.disabled && nt }), [L2, nt, e, G2, C2, c.disabled, a]), Mt = reactExports.useMemo(() => A2 ? A2(tt) : reactExports.createElement(xt.Provider, { value: tt }, V2), [V2, tt, A2]);
  return reactExports.createElement(reactExports.Fragment, null, j !== null && reactExports.createElement("noscript", null, reactExports.createElement("style", null, j)), reactExports.createElement("div", { ref: K2, "data-input-otp-container": true, style: Tt, className: q2 }, Mt, reactExports.createElement("div", { style: { position: "absolute", inset: 0, pointerEvents: "none" } }, It)));
});
...
const InputOTPSlot = reactExports.forwardRef(({ index: index2, className, ...props }, ref) => {
...
const InputOTPSeparator = reactExports.forwardRef(({ ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, role: "separator", ...props, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Dot, {}) }));
  ...
  function onSubmit(data) {
    startTransition(() => {
      (async () => {
        ...
        if (new Date(result.created_at).getTime() + 30 * 6e4 < (/* @__PURE__ */ new Date()).getTime()) {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          FormField,
          {
            ...
            name: "token",
            render: ({ field }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(FormItem, { className: "flex flex-col items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FormLabel, { children: "Token" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(FormControl, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(InputOTP, { maxLength: 6, pattern: Ft, ...field, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(InputOTPGroup, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(FormDescription, { children: "We sent a 6-digit code to your email. Please enter it here." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(FormMessage, {})
            ] })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { type: "submit", children: [
          isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, { className: "size-4 animate-spin mr-2" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(LogIn, { className: "size-4 mr-2" }),
          "Verify"
        ] })
      ]
    }
...
function LoginPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative w-screen h-screen flex justify-center items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative max-w-sm w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FormLogin, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -z-[2] bg-primary h-1/2 w-1/2 rounded-full blur-[100px] opacity-25" })
  ] });
}
function NotFound() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "NoFound" });
}
function Layout() {
  const navigate = useNavigate();
  reactExports.useEffect(() => {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Routes, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, {}), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "auth/login", element: /* @__PURE__ */ jsxRuntimeExports.jsx(LoginPage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "*", element: /* @__PURE__ */ jsxRuntimeExports.jsx(NotFound, {}) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "noisy" })
  ] });
}
const initialState = {
  theme: "system",
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(HashRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ThemeProvider, { defaultTheme: "dark", storageKey: "vite-ui-theme", children: [
